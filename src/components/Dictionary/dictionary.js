  ...
  en: [
    {
      ...
      project: "project",
      contact: "contact",
      sloganFirstPart: "Passionate Software Engineer for the crypto space",
      sloganSecondPart: "",
  ...
  ptbr: [
    {
      ...
      project: "projetos",
      contact: "contato",
      sloganFirstPart: "Pense no Desgin,",
      sloganSecondPart: "E eu farei por você!",
      intro: "Websites incríveis com ReactJS.",
      introSecondPart:
        "Programanod desde 2016 para entregar sempre o melhor resultado.",
      span: "Design",
      button: "Saiba mais",
      titleAboutMe: "Sobre",
      messageAboutMe:
  ...
  jp: [
    {
      ...
      project: "プロジェクト",
      contact: "コンタクト",
      sloganFirstPart: "デザインを考える,",
      sloganSecondPart: "そして私はコードを設計します。",
      intro: "ReactJSを使用して美しくデザインされたウェブサイト",
      introSecondPart: "最高の結果を提供するための2016年以降のコーディング。",
      span: "Lorem Ipsum",
      button: "もっと",
      titleAboutMe: "だいたい",
      messageAboutMe:
  ...
  ru: [
    {
      ...
      project: "проекты",
      contact: "контакт",
      sloganFirstPart: "Подумайте о дизайне,",
